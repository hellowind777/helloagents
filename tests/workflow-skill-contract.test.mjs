...
test('workflow skills stay aligned with the new qa-review architecture', () => {
  ...
  assert.equal(existsSync(join(REPO_ROOT, 'skills', 'commands', 'verify', 'SKILL.md')), false)
  assert.equal(existsSync(join(REPO_ROOT, 'skills', 'hello-review', 'SKILL.md')), false)
  assert.equal(existsSync(join(REPO_ROOT, 'skills', 'hello-verify', 'SKILL.md')), false)
