...
test('workflow skill contracts stay aligned with command aliases and artifacts', () => {
  ...
  assert.match(helloUi, /evidence\/advisor\.json/)
  assert.match(helloUi, /evidence\/visual\.json/)
  ...
  assert.match(helloVerify, /evidence\/review\.json/)
  assert.match(helloVerify, /evidence\/visual\.json/)
  assert.match(helloVerify, /evidence\/closeout\.json/)
  ...
  assert.match(verify, /evidence\/advisor\.json/)
  assert.match(verify, /evidence\/visual\.json/)
  ...
  assert.match(readme, /evidence\/visual\.json/)
  ...
  assert.match(readmeCn, /evidence\/visual\.json/)
