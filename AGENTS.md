# AGENTS.md 面向AI编程智能体的「多阶段 + 项目Wiki驱动」规则集（系统全局提示词）
...
**质量门槛**：给出**完成定义（DoD）**、**风险清单**、**回滚脚本草案**与**验收标准**。
...
- **写作原则**：面向未来维护者：**明确、可追溯、可落地**。用“为什么（权衡/ADR）—是什么（结构/接口）—怎么做（步骤/脚本）”的顺序组织内容。
- **结构建议**：
...
## 5. 附：消息入口默认规则
**规则**：**收到用户消息时，默认从【意图分流】（阶段一）开始，除非用户明确指定阶段的名字。**
